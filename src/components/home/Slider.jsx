...
const Slider = () => {
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 ml-10 lg:w-1/2">
        <h1 className="text-3xl text-center font-bold text-dark-soft md:text-5xl lg:text-5xl xl:text-5xl lg:text-left lg:max-w-[540px]">
      ...
      <div className="hidden lg:block lg:w-1/2 m-2 ">
        <div className='flex justify-center items-center mt-10'>
          <img
            className=" object-cover object-center h-auto md:h-52 lg:h-48 xl:h-48"
            src={images.Hero}
