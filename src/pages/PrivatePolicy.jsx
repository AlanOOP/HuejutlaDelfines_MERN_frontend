        ...
        <div className='w-3/4 '>
          ...
          <div>
            ...
            <ul className=" space-y-1 text-gray-500 list-inside dark:text-gray-400">
              ...
              <li className="flex items-center pl-4">
                ...
                <p className='flex '>Se utilizarán para proporcionar servicios de entrenamiento en natación y garantizar su participación en eventos y actividades relacionadas con el club.</p>
              </li>
            </ul>
          ...
          <div className='my-4'>
            ...
            <ul>
              <li className="flex items-center pl-4">
                ...
                <p className='flex text-gray-500'>Para llevar un registro preciso de su asistencia a clases, entrenamientos y eventos.</p>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              ...
              <li className='text-gray-500 ml-10'>•	 Su fecha de nacimiento es relevante para determinar su grupo de edad en competiciones y campeonatos.</li>
            ...
            <ul>
              ...
              <li className='text-gray-500 ml-10'>•	Su número de teléfono se utilizará para contactarlo en caso de cambios de última hora en eventos o emergencias relacionadas con el club.</li>
            ...
            <ul>
              ...
              <li className='text-gray-500 ml-10'>•	Realizar análisis y estadísticas relacionados con campeonatos, competiciones y pérdidas</li>
            </ul>
          ...
          <div className='mt-10'>
            ...
            <ul className='ml-5'>
              <li className='text-gray-500'>a) ¿A través de qué medios pueden acreditar su identidad el titular y, en su caso, su representante, así como la personalidad este último?Validación telefónica, correo electrónico</li>
              <li className='text-gray-500'>b) ¿Qué información y/o documentación deberá contener la solicitud?
                Nombre completo del titular de los datos
              </li>
              <li className='text-gray-500'>c) ¿En cuántos días le daremos respuesta a su solicitud?</li>
              <li className='text-gray-500'>d) ¿Por qué medio le comunicaremos la respuesta a su solicitud? correo electrónico
              </li>
              <li className='text-gray-500'>e) ¿En qué medios se pueden reproducir los datos personales que, en su caso, solicite?
                Envío por correo electrónico seguro
              </li>
            </ul>

            <p className='text-gray-500 dark:text-gray-400'>Los datos de contacto de la persona o departamento de datos personales, que está a cargo de dar trámite a las solicitudes de derechos ARCO, son los siguientes: </p>

            <ul className='ml-5'>
              <li className='text-gray-500'>a) Nombre de la persona o departamento de datos personales: Lic. Juan Carlos Martínez Magos
              </li>
            </ul>
          </div>
          ...
          <div className='my-10'>
            ...
            <p className='mt-5 text-gray-500 dark:text-gray-400'>•	Puede encontrar y revisar nuestros avisos de privacidad en nuestro sitio web oficial en la sección [proporcionar el enlace directo a la sección de avisos de privacidad].</p>
