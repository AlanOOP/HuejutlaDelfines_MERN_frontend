      ...
      <section className="bg-white ">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400"> Lo sentimos no pudimos encontrar la pagina, regresa al inicio para poder explorar todas las secciones </p>
